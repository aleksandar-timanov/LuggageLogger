...
var _ApiService = class _ApiService {
  constructor(http) {
    this.http = http;
    this.url = isDevMode() && environment.apiUrl !== "" ? environment.apiUrl : "http://localhost:8080";
  }
  getAllUsers() {
...
_UserComponent.\u0275fac = function UserComponent_Factory(t) {
  return new (t || _UserComponent)(\u0275\u0275directiveInject(ApiService));
};
_UserComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserComponent, selectors: [["app-user"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 12, vars: 2, consts: [[1, "background-gray", "flex", "justify-center", "py-10"], [1, "border", "border-solid", "border-black", "w-6/12", 3, "formGroup", "ngSubmit"], [1, "p-3"], ["for", "name", 1, "pr-3"], ["type", "text", "id", "name", "formControlName", "name", 1, "border", "border-solid", "border-gray"], [1, "p-4"], ["for", "email", 1, "pr-3"], ["type", "text", "id", "email", "formControlName", "email", 1, "border", "border-solid", "border-gray"], ["type", "submit", 1, "button", "p-1", "m-3", "border", "border-black", "border-solid", "background-gray", 3, "disabled"]], template: function UserComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "form", 1);
    \u0275\u0275listener("ngSubmit", function UserComponent_Template_form_ngSubmit_1_listener() {
      return ctx.onSubmit();
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(9);
    \u0275\u0275property("disabled", !ctx.userForm.valid);
  }
...
var _AppComponent = class _AppComponent {
  constructor() {
    this.title = "LuggageLogger";
  }
};
_AppComponent.\u0275fac = function AppComponent_Factory(t) {
  return new (t || _AppComponent)();
};
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 0, consts: [[1, "relative", "flex", "h-screen", "justify-center", "bg-blue-900", "bg-hero-pattern", "bg-cover", "bg-blend-multiply"], [1, "container", "sm:w-3/5"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var _IconsModule = class _IconsModule {
};
_IconsModule.\u0275fac = function IconsModule_Factory(t) {
  return new (t || _IconsModule)();
};
_IconsModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _IconsModule });
_IconsModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [FeatherModule.pick(icons), FeatherModule] });
var IconsModule = _IconsModule;
...
_ModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ModalComponent, selectors: [["app-modal"]], outputs: { closeModal: "closeModal" }, standalone: true, features: [\u0275\u0275StandaloneFeature], ngContentSelectors: _c02, decls: 5, vars: 0, consts: [[1, "absolute", "left-0", "top-0", "z-40", "h-screen", "w-screen", "bg-black", "opacity-50"], [1, "absolute", "left-1/2", "top-1/2", "z-50", "grid", "h-fit", "max-h-screen", "w-fit", "min-w-[75%]", "max-w-md", "-translate-x-1/2", "-translate-y-1/2", "flex-row", "rounded-md", "bg-blue-900", "p-10", "text-white", "ring-2", "ring-offset-2"], [1, "absolute", "right-3", "top-3", "grid", "cursor-pointer", "rounded-full", "hover:bg-orange-700", 3, "click"], ["name", "x-circle"]], template: function ModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275projectionDef();
    \u0275\u0275element(0, "div", 0);
    \u0275\u0275elementStart(1, "div", 1)(2, "div", 2);
    \u0275\u0275listener("click", function ModalComponent_Template_div_click_2_listener() {
      return ctx.onModalCloseClick();
    });
    \u0275\u0275element(3, "i-feather", 3);
    \u0275\u0275elementEnd();
    \u0275\u0275projection(4);
    \u0275\u0275elementEnd();
  }
}, dependencies: [IconsModule, FeatherComponent], styles: ["\n\n/*# sourceMappingURL=modal.component.css.map */"] });
var ModalComponent = _ModalComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModalComponent, { className: "ModalComponent", filePath: "src/app/components/modal/modal.component.ts", lineNumber: 11 });
})();

// src/app/components/create-trip/create-trip.component.ts
var _c03 = ["destination"];
var _CreateTripComponent = class _CreateTripComponent {
  constructor() {
    this.tripSubmitted = new EventEmitter();
    this.trip = {};
    this.newTrip = new FormGroup({
      destination: new FormControl("", Validators.required),
      departureDate: new FormControl(/* @__PURE__ */ new Date(), Validators.required),
      returnDate: new FormControl(/* @__PURE__ */ new Date(), Validators.required)
    });
  }
  ngAfterViewInit() {
...
_CreateTripComponent.\u0275fac = function CreateTripComponent_Factory(t) {
  return new (t || _CreateTripComponent)();
};
_CreateTripComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CreateTripComponent, selectors: [["app-create-trip"]], viewQuery: function CreateTripComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuery(_c03, 5);
  }
  if (rf & 2) {
    let _t;
    \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.destinationInput = _t.first);
  }
}, outputs: { tripSubmitted: "tripSubmitted" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 17, vars: 1, consts: [[1, "h-full", "w-full"], [1, "m-auto", "w-2/3", 3, "formGroup", "ngSubmit"], [1, "mb-3", "grid", "w-full"], ["for", "destination", 1, "mb-1", "w-full", "text-xl"], ["type", "text", "formControlName", "destination", "name", "destination", "value", "", "placeholder", "Where are we going next?", 1, "rounded-md", "p-2", "text-black"], ["destination", ""], ["for", "departureDate", 1, "mb-1", "w-full", "text-xl"], ["type", "date", "name", "departureDate", "formControlName", "departureDate", "value", "", 1, "rounded-md", "p-2", "text-black"], ["for", "returnDate", 1, "mb-1", "w-full", "text-xl"], ["type", "date", "name", "returnDate", "formControlName", "returnDate", "value", "", 1, "rounded-md", "p-2", "text-black"], ["type", "submit", 1, "h-fit", "w-fit", "rounded-md", "bg-cyan-700", "p-4", "text-center"]], template: function CreateTripComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "form", 1);
    \u0275\u0275listener("ngSubmit", function CreateTripComponent_Template_form_ngSubmit_1_listener() {
      return ctx.onSubmitNewTrip();
    });
    \u0275\u0275elementStart(2, "div", 2)(3, "label", 3);
    \u0275\u0275text(4, "Destination");
    \u0275\u0275elementEnd();
    \u0275\u0275element(5, "input", 4, 5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 2)(8, "label", 6);
    \u0275\u0275text(9, "Date of departure");
    \u0275\u0275elementEnd();
    \u0275\u0275element(10, "input", 7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 2)(12, "label", 8);
    \u0275\u0275text(13, "Date of return");
    \u0275\u0275elementEnd();
    \u0275\u0275element(14, "input", 9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "button", 10);
    \u0275\u0275text(16, " Submit new trip ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275property("formGroup", ctx.newTrip);
  }
}, dependencies: [ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName], styles: ["\n\n/*# sourceMappingURL=create-trip.component.css.map */"] });
var CreateTripComponent = _CreateTripComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CreateTripComponent, { className: "CreateTripComponent", filePath: "src/app/components/create-trip/create-trip.component.ts", lineNumber: 23 });
})();

// src/app/components/all-trips/all-trips.component.ts
var _forTrack0 = ($index, $item) => $item.id;
function AllTripsComponent_For_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 5);
    \u0275\u0275listener("click", function AllTripsComponent_For_5_Template_div_click_0_listener() {
      const restoredCtx = \u0275\u0275restoreView(_r9);
      const trip_r3 = restoredCtx.$implicit;
      const ctx_r8 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r8.onChooseTrip(trip_r3.id));
    });
    \u0275\u0275elementStart(1, "div", 6);
    \u0275\u0275listener("click", function AllTripsComponent_For_5_Template_div_click_1_listener($event) {
      const restoredCtx = \u0275\u0275restoreView(_r9);
      const trip_r3 = restoredCtx.$implicit;
      const ctx_r10 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r10.onDeleteClick($event, trip_r3.id));
    });
    \u0275\u0275element(2, "i-feather", 7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 8);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 9)(6, "div");
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "date");
    \u0275\u0275pipe(9, "date");
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", trip_r3.destination, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind1(8, 3, trip_r3.departureDate), " - ", \u0275\u0275pipeBind1(9, 5, trip_r3.returnDate), " ");
  }
}
function AllTripsComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-modal", 10);
    \u0275\u0275listener("closeModal", function AllTripsComponent_Conditional_8_Template_app_modal_closeModal_0_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r11 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r11.onCancelDeleteClick());
    });
    \u0275\u0275elementStart(1, "div", 11)(2, "span");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 12)(5, "button", 13);
    \u0275\u0275listener("click", function AllTripsComponent_Conditional_8_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r13 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r13.onConfirmDeleteClick(ctx_r13.deleteModalOpenedFor));
    });
    \u0275\u0275text(6, " Delete ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 13);
    \u0275\u0275listener("click", function AllTripsComponent_Conditional_8_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r14 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r14.onCancelDeleteClick());
    });
    \u0275\u0275text(8, " Cancel ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Are you sure you want to delete trip ", ctx_r1.deleteModalOpenedFor, "? ");
  }
}
function AllTripsComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-modal", 10);
    \u0275\u0275listener("closeModal", function AllTripsComponent_Conditional_9_Template_app_modal_closeModal_0_listener() {
      \u0275\u0275restoreView(_r16);
      const ctx_r15 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r15.onCancelCreateClick());
    });
    \u0275\u0275elementStart(1, "app-create-trip", 14);
    \u0275\u0275listener("tripSubmitted", function AllTripsComponent_Conditional_9_Template_app_create_trip_tripSubmitted_1_listener($event) {
      \u0275\u0275restoreView(_r16);
      const ctx_r17 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r17.onNewTripSubmitted($event));
    });
    \u0275\u0275elementEnd()();
  }
}
var _AllTripsComponent = class _AllTripsComponent {
  ...
  onConfirmDeleteClick(tripToDeleteId) {
    this.temporaryData.splice(this.temporaryData.map((trip) => trip.id).indexOf(tripToDeleteId), 1);
    this.deleteModalOpenedFor = null;
  }
  onCreateCardClick() {
    this.isCreateModalOpen = true;
  }
  onNewTripSubmitted(trip) {
    console.log(trip);
    this.temporaryData.push(__spreadValues({ id: this.temporaryData.length }, trip));
    this.isCreateModalOpen = false;
  }
};
...
_AllTripsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AllTripsComponent, selectors: [["app-all-trips"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 10, vars: 2, consts: [[1, "container", "w-full", "py-16"], [1, "text-5xl", "font-extrabold", "text-white"], [1, "mx-5", "grid", "gap-6", "sm:m-0", "md:grid-cols-3"], [1, "w-50", "grid", "h-32", "w-full", "cursor-pointer", "content-center", "justify-center", "gap-x-2", "rounded-md", "border", "border-solid", "border-white", "bg-cyan-700", "p-3", "text-white", "transition", "duration-200", "hover:bg-cyan-600", 3, "click"], ["name", "plus-circle"], [1, "w-50", "relative", "z-10", "h-32", "w-full", "cursor-pointer", "gap-x-2", "rounded-md", "border", "border-solid", "border-white", "bg-cyan-700", "p-3", "text-white", "transition", "duration-200", "hover:bg-cyan-600", 3, "click"], [1, "absolute", "right-3", "z-20", "grid", "content-center", "justify-center", "rounded-md", "bg-cyan-600", "p-1", "transition", "duration-200", "hover:bg-orange-700", 3, "click"], ["name", "trash-2"], [1, "flex", "w-full", "justify-start", "text-2xl", "font-extrabold"], [1, "text-l", "flex", "h-full", "w-full", "items-center", "justify-end", "font-bold"], [3, "closeModal"], [1, "grid", "w-full", "place-items-center", "pb-10", "text-2xl"], [1, "flex", "flex-row", "items-center", "justify-around"], [1, "h-fit", "w-fit", "rounded-md", "bg-cyan-700", "p-4", "text-center", 3, "click"], [3, "tripSubmitted"], ["class", "w-50 relative z-10 h-32 w-full cursor-pointer gap-x-2 rounded-md border border-solid border-white bg-cyan-700 p-3 text-white transition duration-200 hover:bg-cyan-600"]], template: function AllTripsComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, AllTripsComponent_For_5_Template, 10, 7, "div", 15, _forTrack0);
    \u0275\u0275elementStart(6, "div", 3);
    \u0275\u0275listener("click", function AllTripsComponent_Template_div_click_6_listener() {
      return ctx.onCreateCardClick();
    });
    \u0275\u0275element(7, "i-feather", 4);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, AllTripsComponent_Conditional_8_Template, 9, 1, "app-modal")(9, AllTripsComponent_Conditional_9_Template, 2, 0, "app-modal");
  }
  if (rf & 2) {
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx.temporaryData);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(8, ctx.deleteModalOpenedFor || ctx.deleteModalOpenedFor === 0 ? 8 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(9, ctx.isCreateModalOpen ? 9 : -1);
  }
...
var _EditTripComponent = class _EditTripComponent {
};
_EditTripComponent.\u0275fac = function EditTripComponent_Factory(t) {
  return new (t || _EditTripComponent)();
};
_EditTripComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditTripComponent, selectors: [["app-edit-trip"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 2, vars: 0, template: function EditTripComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1, "edit-trip works!");
    \u0275\u0275elementEnd();
  }
}, styles: ["\n\n/*# sourceMappingURL=edit-trip.component.css.map */"] });
var EditTripComponent = _EditTripComponent;
(() => {
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-BEXQ7VDV.mjs.map
